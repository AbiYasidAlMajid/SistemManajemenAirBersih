...
class AirBersihAdmin(models.Model):
...
class GolonganPelanggan(models.Model):
    ...
    golongan_pelanggan = models.CharField(max_length=100)
    ...
    def __str__(self):
        return self.golongan_pelanggan
...
class Pengaduan(models.Model):
    ...
    id_user = models.ForeignKey(Pengguna, on_delete=models.CASCADE, related_name='pengaduan')
    ...
    def __str__(self):
        return f"Pengguna: {self.id_user} - Jenis Pengaduan: {self.jenis_pengaduan}"
...
class Tagihan(models.Model):
    ...
    id_user = models.ForeignKey(Pengguna, on_delete=models.CASCADE, related_name='tagihan')
    ...
    def __str__(self):
        return f"Tagihan #{self.id_tagihan} - Pengguna: {self.id_user} - Periode: {self.periode}"
...
class Pembayaran(models.Model):
    ...
    id_user = models.ForeignKey(Pengguna, on_delete=models.CASCADE, related_name='pembayaran')
    ...
    def __str__(self):
        return f"Pembayaran #{self.id_pembayaran} - Pengguna: {self.id_user} - Tagihan: {self.id_tagihan}"